...
-(NSString*) syntaxColoredTextView: (ULISyntaxColoredTextView*)sender stringForSnippedOnPasteboard: (NSPasteboard*)pboard;	// If your snippet flavor is not raw string data, implement this to unpack it into a string we can insert into the code. Not implementing this will result in -stringForType: being called on the pasteboard and inserting that.
